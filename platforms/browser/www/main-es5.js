...
var StorageService = /** @class */ (function () {
    ...
    StorageService.prototype.getLocalUser = function () {
        var usr = localStorage.getItem(_environments_storage_keys_config__WEBPACK_IMPORTED_MODULE_3__["STORAGE_KEYS"].localUser);
        if (usr == null) {
            return null;
        }
        else {
...
var ErrorInterceptor = /** @class */ (function () {
    function ErrorInterceptor(storage, toastCtrl) {
        this.storage = storage;
