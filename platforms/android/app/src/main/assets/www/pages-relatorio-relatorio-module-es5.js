...
var RelatorioPage = /** @class */ (function () {
    function RelatorioPage(bluetoothSerial, contribService, datePipe, dataLocal, popoverCtrl) {
    ...
    RelatorioPage.prototype.connect = function () {
    ...
    RelatorioPage.prototype.disconnectDevices = function () {
    ...
    RelatorioPage.prototype.mostrarRecidos = function () {
...
var DataLocalService = /** @class */ (function () {
    ...
    DataLocalService.prototype.guardarRecibos = function (objetos) {
