...
var Tab2Page = /** @class */ (function () {
    function Tab2Page(navCtrl, calendar, bluetoothSerial, crudService, contribService, toastCtrl, storage, usuarioService) {
    ...
    Tab2Page.prototype.carregarContribuintes = function () {
        ...
        if (localUser && localUser.email) {
            this.usuarioService.findByEmail(localUser.email)
                ...
                _this.contribService.getListaRecibos(_this.codMens).subscribe(function (resp) {
                    var _a;
