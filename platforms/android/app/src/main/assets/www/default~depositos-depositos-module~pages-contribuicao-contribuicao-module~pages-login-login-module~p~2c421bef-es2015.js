...
let DetalheComponent = class DetalheComponent {
    constructor(contribService, modalCtrl, actionSheetCtrl, datePipe, toastCtrl, alertCtrl, bluetoothSerial, crudService) {
    ...
    connectOrDisconnectPrint() {
        if (this.conectPrint = !this.conectPrint) {
            this.bluetoothSerial.connectInsecure("02:36:0D:6B:4D:F3" || false || false).subscribe((data) => {
