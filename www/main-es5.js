...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, database) {
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            _this.database.createDataBase().then(function () {
                _this.abrirPage(_this.splashScreen);
    ...
    AppComponent.prototype.abrirPage = function (splashScreen) {
        splashScreen.hide();
    };
...
/* harmony import */ var _ionic_native_calendar_ngx__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ionic-native/calendar/ngx */ "./node_modules/@ionic-native/calendar/ngx/index.js");
...
/* harmony import */ var _ionic_native_sqlite_ngx__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @ionic-native/sqlite/ngx */ "./node_modules/@ionic-native/sqlite/ngx/index.js");
/* harmony import */ var _services_auth_services__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./services/auth.services */ "./src/app/services/auth.services.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _ionic_native_calendar_ngx__WEBPACK_IMPORTED_MODULE_10__["Calendar"],
...
var AuthService = /** @class */ (function () {
    function AuthService(http, storage) {
        ...
        this.jwtHelperService = new _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_5__["JwtHelperService"]();
    }
    ...
    AuthService.prototype.successfullLogin = function (authorization) {
        var tok = authorization.substring(7);
        var user = {
            token: tok,
...
var DatabaseService = /** @class */ (function () {
    ...
    DatabaseService.prototype.getDB = function () {
    ...
    DatabaseService.prototype.createTables = function (db) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var e_2;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
...
var StorageService = /** @class */ (function () {
    ...
    StorageService.prototype.setRecibos = function (objetos) {
        this.objetos.push(objetos);
        this.storage.set('objetos', this.objetos);
    };
    StorageService.prototype.getLocalUser = function () {
        var usr = localStorage.getItem(_config_storage_keys_config__WEBPACK_IMPORTED_MODULE_3__["STORAGE_KEYS"].localUser);
        if (usr == null) {
            return null;
        }
        else {
...
var UsuarioService = /** @class */ (function () {
    ...
    UsuarioService.prototype.getApiDbPostDepositos = function (deposito) {
...
/* harmony import */ var _app_services_storage_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../app/services/storage.service */ "./src/app/services/storage.service.ts");




var URL = _environments_environment_prod__WEBPACK_IMPORTED_MODULE_2__["environment"].url;
var AuthInterceptor = /** @class */ (function () {
    ...
    AuthInterceptor.prototype.intercept = function (req, next) {
        ...
        var N = URL.length;
        var requestToAPI = req.url.substring(0, N) == URL;
    ...
    AuthInterceptor.ctorParameters = function () { return [
        { type: _app_services_storage_service__WEBPACK_IMPORTED_MODULE_3__["StorageService"] }
    ]; };
    AuthInterceptor = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_app_services_storage_service__WEBPACK_IMPORTED_MODULE_3__["StorageService"]])
    ], AuthInterceptor);
...
var ErrorInterceptor = /** @class */ (function () {
    function ErrorInterceptor(storage, toastCtrl, alertCtrl) {
        this.storage = storage;
    ...
    ErrorInterceptor.prototype.presentToast = function (message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
...
module.exports = __webpack_require__(/*! C:\temp\ws-ionic\XExpressApp\src\main.ts */"./src/main.ts");
