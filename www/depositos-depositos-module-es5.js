...
module.exports = ".welcome-card img {\n  max-height: 35vh;\n  overflow: hidden;\n}\n\nion-slides {\n  width: 90%;\n}\n\n.buttonNext {\n  margin-top: 7%;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var Tab1Page = /** @class */ (function () {
    ...
    Tab1Page.prototype.selectByCodValidacao = function (event) {
        this.codValid = event.detail.value;
        console.log("Código de validação: ", this.codValid);
    };
    Tab1Page.prototype.selectByValorDespesa = function (event) {
    ...
    Tab1Page.prototype.getForDep = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var datadorecebimento;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        datadorecebimento = this.datePipe.transform(this.dtFech, 'dd/MM/yyyy');
                        console.log('DATA RECEBIMENTO: ', datadorecebimento);
                        return [4 /*yield*/, this.crud.getForDeposito(datadorecebimento)
                                .then(function (data) {
                                var _a;
                                (_a = _this.listaDeRecibos).push.apply(_a, data);
                                for (var i = 0; i < _this.listaDeRecibos.length; i++) {
                                    _this.qtdRecibos = _this.listaDeRecibos[0].qtdRecibos;
                                    _this.valorDeposito = _this.listaDeRecibos[0].totalArrecadado;
                                }
                                console.log('QTD RECIBOS: ' + _this.qtdRecibos + '\tTOTAL ARRECADADO: ' + _this.valorDeposito);
                                _this.setObjDeposito(_this.qtdRecibos, _this.valorDeposito);
                            }, function (error) {
    ...
    Tab1Page.prototype.setObjDeposito = function (qtdRec, valorTotal) {
        this.deposito = new _class_depositos__WEBPACK_IMPORTED_MODULE_4__["Depositos"]();
...
//# sourceMappingURL=depositos-depositos-module-es5.js.map